...
class _EmailLoginScreenState extends ConsumerState<EmailLoginScreen> {
  ...
  Future<void> _submit() async {
    // The button disables itself while loading, but the keyboard's done key
    // reaches here directly, so guard the in-flight case here too.
    if (ref.read(authViewModelProvider).value?.isEmailLoading ?? false) return;
    if (!_formKey.currentState!.validate()) return;

    // Tells the platform the credentials are complete, so it can offer to save
    // them to the keychain / password manager.
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    // Without these the OS keychain and password managers never
                    // offer to fill or save the credentials.
                  ...
                  TextFormField(
                    ...
                    // The keyboard's action key used to insert a newline and do
                    // nothing — the user had to dismiss it to reach the button.
                  ...
                  if (authState.errorCode != null)
                    Padding(
                      ...
                      child: Text(
                        authErrorText(l10n, authState.errorCode!),
                  ...
                  TextButton(
                    ...
                    child: AppUnderlinedText(
                      _isLoginMode
                          ? l10n.emailLoginToggleSignUp
                          : l10n.emailLoginToggleLogin,
