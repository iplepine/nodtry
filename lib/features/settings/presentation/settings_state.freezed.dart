...
@override
int get hashCode => Object.hash(runtimeType,currentLocale,currentTheme,isWithdrawing,errorMessage);

@override
String toString() {
  return 'SettingsState(currentLocale: $currentLocale, currentTheme: $currentTheme, isWithdrawing: $isWithdrawing, errorMessage: $errorMessage)';
}
